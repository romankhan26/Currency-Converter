...
let userAnswer = await inquirer.prompt([
    {
        name: "from",
        message: chalk.bold.grey.bgYellow("What currency do you want to convert from?"),
        type: "list",
        choices: ["USD", "EUR", "GBP", "INR", "PKR", "AFN", "ALL"],
    },
    {
        name: "amount",
        message: chalk.bold.grey.bgGray("How much currency do you want to convert?"),
        type: "number",
    },
    {
        name: "to",
        message: chalk.bold.grey.bgYellow("What currency do you want to convert to?"),
        type: "list",
        choices: ["USD", "EUR", "GBP", "INR", "PKR", "AFN", "ALL"],
    },
]);
